...
const allStaff: StaffInfo[] = [
  ...
  {
    name: "[hta] Caitlin",
    desc: "Hello! I'm Caitlin, a senior studying Cognitive Science from California. I love reading & art, most things outdoors, and am on the club tennis team here at Brown!",
    pooh: "./images/icons/pooh caitlin.png",
    real: "./images/tas/caitlin.jpg",
  },
  {
    name: "[hta] Jess",
    desc: "Hi! I'm Jess, a senior concentrating in CS. In my free time, I love watching asian dramas, eating yummy food, and taking late night naps :) So excited to meet you!",
    pooh: "./images/icons/pooh jess.png",
    real: "./images/tas/jess.jpg",
  },
  {
    name: "Alex",
